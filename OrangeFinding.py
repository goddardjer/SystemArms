...
while True:
    ...
    # Define range for bright, more red shade of orange color in LAB
    lower_orange = np.array([0, 110, 110])  # Increase the lower bound of a
    upper_orange = np.array([255, 140, 140])  # Decrease the upper bound of b

    # Threshold the LAB image to get only bright, more red shade of orange colors
    ...
    if cnts:
        ...
        # Get the LAB value of the center of the contour
        lab_value = lab[cY, cX]

        # Display the LAB value at the center of the contour
        cv2.putText(frame, str(lab_value), (cX, cY), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
